...
if __name__ == '__main__':
    ...
    name = ["contacts", "mail", "classroom", "meet", "about"] # Subdomains list
		
    domain_scanner(domain_name, name)
